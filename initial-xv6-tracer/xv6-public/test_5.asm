...
int main() {
  ...
  11:	68 00 a0 00 00       	push   $0xa000
  16:	e8 08 03 00 00       	call   323 <trace>
  printf(1, "XV6_TEST_OUTPUT %d\n", ret);
  1b:	83 c4 0c             	add    $0xc,%esp
  1e:	50                   	push   %eax
  1f:	68 18 07 00 00       	push   $0x718
  24:	6a 01                	push   $0x1
  26:	e8 c5 03 00 00       	call   3f0 <printf>
  exit();
 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 379:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
 ...
 3f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 469:	ff 24 85 34 07 00 00 	jmp    *0x734(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 577:	90                   	nop
          s = "(null)";
 578:	ba 2c 07 00 00       	mov    $0x72c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 591:	a1 34 0a 00 00       	mov    0xa34,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 609:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60c:	89 15 34 0a 00 00    	mov    %edx,0xa34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	73 4f                	jae    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	8b 3d 34 0a 00 00    	mov    0xa34,%edi
 ...
 69a:	e8 f1 fe ff ff       	call   590 <free>
  return freep;
 69f:	8b 15 34 0a 00 00    	mov    0xa34,%edx
 ...
 6cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 34 0a 00 00    	mov    %edx,0xa34
}
 ...
 6df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	bf 38 0a 00 00       	mov    $0xa38,%edi
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 6f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6fb:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 702:	00 00 00 
    if(p->s.size >= nunits){
