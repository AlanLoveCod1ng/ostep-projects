...
int main() {
  ...
  17:	68 68 07 00 00       	push   $0x768
  1c:	e8 52 03 00 00       	call   373 <trace>
  21:	83 c4 10             	add    $0x10,%esp
  24:	85 c0                	test   %eax,%eax
  26:	78 39                	js     61 <main+0x61>
  ...
  33:	6a 00                	push   $0x0
  35:	68 68 07 00 00       	push   $0x768
  3a:	e8 d4 02 00 00       	call   313 <open>
  for (int i = 0; i < 10000; i++) {
  ...
  int ret = getcount();
  47:	e8 2f 03 00 00       	call   37b <getcount>
  printf(1, "XV6_TEST_OUTPUT %d\n", ret);
  4c:	83 ec 04             	sub    $0x4,%esp
  4f:	50                   	push   %eax
  50:	68 8f 07 00 00       	push   $0x78f
  55:	6a 01                	push   $0x1
  57:	e8 e4 03 00 00       	call   440 <printf>

  exit();
  5c:	e8 72 02 00 00       	call   2d3 <exit>
    printf(1, "XV6_TEST_OUTPUT trace failed\n");
  61:	50                   	push   %eax
  62:	50                   	push   %eax
  63:	68 71 07 00 00       	push   $0x771
  68:	6a 01                	push   $0x1
  6a:	e8 d1 03 00 00       	call   440 <printf>
    exit();
  6f:	e8 5f 02 00 00       	call   2d3 <exit>
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 ac 07 00 00 	jmp    *0x7ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba a3 07 00 00       	mov    $0x7a3,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 b0 0a 00 00    	mov    %edx,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf b4 0a 00 00       	mov    $0xab4,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 752:	00 00 00 
    if(p->s.size >= nunits){
