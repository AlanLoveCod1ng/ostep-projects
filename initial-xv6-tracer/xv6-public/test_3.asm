...
int main() {
  ...
  1d:	e8 71 03 00 00       	call   393 <trace>
  int ret0 = getcount();
  22:	e8 74 03 00 00       	call   39b <getcount>
  trace(PATH2);
  27:	c7 04 24 92 07 00 00 	movl   $0x792,(%esp)
  int ret0 = getcount();
  2e:	89 c6                	mov    %eax,%esi
  trace(PATH2);
  30:	e8 5e 03 00 00       	call   393 <trace>
  ...
  43:	6a 00                	push   $0x0
  45:	68 92 07 00 00       	push   $0x792
  4a:	e8 e4 02 00 00       	call   333 <open>
  for (int i = 0; i < iter; i++)
  4f:	83 c4 10             	add    $0x10,%esp
  52:	83 eb 01             	sub    $0x1,%ebx
  55:	75 e9                	jne    40 <main+0x40>
  int ret1 = getcount();
  57:	e8 3f 03 00 00       	call   39b <getcount>

  trace(PATH1);
  5c:	83 ec 0c             	sub    $0xc,%esp
  5f:	68 88 07 00 00       	push   $0x788
  int ret1 = getcount();
  64:	89 c3                	mov    %eax,%ebx
  trace(PATH1);
  66:	e8 28 03 00 00       	call   393 <trace>
  open(PATH1, 537);
  6b:	58                   	pop    %eax
  6c:	5a                   	pop    %edx
  6d:	68 19 02 00 00       	push   $0x219
  72:	68 88 07 00 00       	push   $0x788
  77:	e8 b7 02 00 00       	call   333 <open>
  int ret2 = getcount();
  7c:	e8 1a 03 00 00       	call   39b <getcount>

  printf(1, "XV6_TEST_OUTPUT %d %d %d\n", ret0, ret1, ret2);
  81:	89 04 24             	mov    %eax,(%esp)
  84:	53                   	push   %ebx
  85:	56                   	push   %esi
  86:	68 9c 07 00 00       	push   $0x79c
  8b:	6a 01                	push   $0x1
  8d:	e8 ce 03 00 00       	call   460 <printf>

  exit();
  92:	83 c4 20             	add    $0x20,%esp
  95:	e8 59 02 00 00       	call   2f3 <exit>
  9a:	66 90                	xchg   %ax,%ax
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 c0 07 00 00 	jmp    *0x7c0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba b6 07 00 00       	mov    $0x7b6,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 c8 0a 00 00    	mov    %edx,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
 ...
 6f3:	e8 83 fc ff ff       	call   37b <sbrk>
  if(p == (char*)-1)
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 c8 0a 00 00 cc 	movl   $0xacc,0xac8
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf cc 0a 00 00       	mov    $0xacc,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 772:	00 00 00 
    if(p->s.size >= nunits){
