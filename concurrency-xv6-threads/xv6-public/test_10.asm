...
worker(void *arg1, void *arg2) {
  ...
  16:	0f 85 a0 00 00 00    	jne    bc <worker+0xbc>
   assert(global == 1);
  1c:	a1 00 0d 00 00       	mov    0xd00,%eax
  21:	83 f8 01             	cmp    $0x1,%eax
  24:	0f 84 db 00 00 00    	je     105 <worker+0x105>
  2a:	6a 2f                	push   $0x2f
  2c:	68 a0 08 00 00       	push   $0x8a0
  31:	68 aa 08 00 00       	push   $0x8aa
  36:	6a 01                	push   $0x1
  38:	e8 b3 05 00 00       	call   5f0 <printf>
  3d:	83 c4 0c             	add    $0xc,%esp
  40:	68 f1 08 00 00       	push   $0x8f1
  45:	68 c1 08 00 00       	push   $0x8c1
  4a:	6a 01                	push   $0x1
  4c:	e8 9f 05 00 00       	call   5f0 <printf>
  51:	83 c4 08             	add    $0x8,%esp
  54:	68 d5 08 00 00       	push   $0x8d5
  59:	6a 01                	push   $0x1
  5b:	e8 90 05 00 00       	call   5f0 <printf>
  60:	83 c4 04             	add    $0x4,%esp
  63:	ff 35 04 0d 00 00    	push   0xd04
  69:	e8 5d 04 00 00       	call   4cb <kill>
  6e:	e8 28 04 00 00       	call   49b <exit>
   assert(arg1_int == 35);
  73:	6a 2d                	push   $0x2d
  75:	68 a0 08 00 00       	push   $0x8a0
  7a:	68 aa 08 00 00       	push   $0x8aa
  7f:	6a 01                	push   $0x1
  81:	e8 6a 05 00 00       	call   5f0 <printf>
  86:	83 c4 0c             	add    $0xc,%esp
  89:	68 b2 08 00 00       	push   $0x8b2
  8e:	68 c1 08 00 00       	push   $0x8c1
  93:	6a 01                	push   $0x1
  95:	e8 56 05 00 00       	call   5f0 <printf>
  9a:	83 c4 08             	add    $0x8,%esp
  9d:	68 d5 08 00 00       	push   $0x8d5
  a2:	6a 01                	push   $0x1
  a4:	e8 47 05 00 00       	call   5f0 <printf>
  a9:	83 c4 04             	add    $0x4,%esp
  ac:	ff 35 04 0d 00 00    	push   0xd04
  b2:	e8 14 04 00 00       	call   4cb <kill>
  b7:	e8 df 03 00 00       	call   49b <exit>
   assert(arg2_int == 42);
  bc:	6a 2e                	push   $0x2e
  be:	68 a0 08 00 00       	push   $0x8a0
  c3:	68 aa 08 00 00       	push   $0x8aa
  c8:	6a 01                	push   $0x1
  ca:	e8 21 05 00 00       	call   5f0 <printf>
  cf:	83 c4 0c             	add    $0xc,%esp
  d2:	68 e2 08 00 00       	push   $0x8e2
  d7:	68 c1 08 00 00       	push   $0x8c1
  dc:	6a 01                	push   $0x1
  de:	e8 0d 05 00 00       	call   5f0 <printf>
  e3:	83 c4 08             	add    $0x8,%esp
  e6:	68 d5 08 00 00       	push   $0x8d5
  eb:	6a 01                	push   $0x1
  ed:	e8 fe 04 00 00       	call   5f0 <printf>
  f2:	83 c4 04             	add    $0x4,%esp
  f5:	ff 35 04 0d 00 00    	push   0xd04
  fb:	e8 cb 03 00 00       	call   4cb <kill>
 100:	e8 96 03 00 00       	call   49b <exit>
   global++;
 105:	83 c0 01             	add    $0x1,%eax
 108:	a3 00 0d 00 00       	mov    %eax,0xd00
   exit();
 10d:	e8 89 03 00 00       	call   49b <exit>
...
00000112 <main>:
{
 ...
 121:	83 ec 10             	sub    $0x10,%esp
   ppid = getpid();
 124:	e8 f2 03 00 00       	call   51b <getpid>
 129:	a3 04 0d 00 00       	mov    %eax,0xd04
   int arg1 = 35;
 ...
 15a:	e8 d0 02 00 00       	call   42f <thread_join>
   assert(join_pid == thread_pid);
 15f:	39 c3                	cmp    %eax,%ebx
 161:	0f 85 9f 00 00 00    	jne    206 <main+0xf4>
   assert(global == 2);
 167:	83 3d 00 0d 00 00 02 	cmpl   $0x2,0xd00
 16e:	0f 84 db 00 00 00    	je     24f <main+0x13d>
 174:	6a 23                	push   $0x23
 176:	68 a0 08 00 00       	push   $0x8a0
 17b:	68 aa 08 00 00       	push   $0x8aa
 180:	6a 01                	push   $0x1
 182:	e8 69 04 00 00       	call   5f0 <printf>
 187:	83 c4 0c             	add    $0xc,%esp
 18a:	68 23 09 00 00       	push   $0x923
 18f:	68 c1 08 00 00       	push   $0x8c1
 194:	6a 01                	push   $0x1
 196:	e8 55 04 00 00       	call   5f0 <printf>
 19b:	83 c4 08             	add    $0x8,%esp
 19e:	68 d5 08 00 00       	push   $0x8d5
 1a3:	6a 01                	push   $0x1
 1a5:	e8 46 04 00 00       	call   5f0 <printf>
 1aa:	83 c4 04             	add    $0x4,%esp
 1ad:	ff 35 04 0d 00 00    	push   0xd04
 1b3:	e8 13 03 00 00       	call   4cb <kill>
 1b8:	e8 de 02 00 00       	call   49b <exit>
   assert(thread_pid > 0);
 1bd:	6a 1f                	push   $0x1f
 1bf:	68 a0 08 00 00       	push   $0x8a0
 1c4:	68 aa 08 00 00       	push   $0x8aa
 1c9:	6a 01                	push   $0x1
 1cb:	e8 20 04 00 00       	call   5f0 <printf>
 1d0:	83 c4 0c             	add    $0xc,%esp
 1d3:	68 fd 08 00 00       	push   $0x8fd
 1d8:	68 c1 08 00 00       	push   $0x8c1
 1dd:	6a 01                	push   $0x1
 1df:	e8 0c 04 00 00       	call   5f0 <printf>
 1e4:	83 c4 08             	add    $0x8,%esp
 1e7:	68 d5 08 00 00       	push   $0x8d5
 1ec:	6a 01                	push   $0x1
 1ee:	e8 fd 03 00 00       	call   5f0 <printf>
 1f3:	83 c4 04             	add    $0x4,%esp
 1f6:	ff 35 04 0d 00 00    	push   0xd04
 1fc:	e8 ca 02 00 00       	call   4cb <kill>
 201:	e8 95 02 00 00       	call   49b <exit>
   assert(join_pid == thread_pid);
 206:	6a 22                	push   $0x22
 208:	68 a0 08 00 00       	push   $0x8a0
 20d:	68 aa 08 00 00       	push   $0x8aa
 212:	6a 01                	push   $0x1
 214:	e8 d7 03 00 00       	call   5f0 <printf>
 219:	83 c4 0c             	add    $0xc,%esp
 21c:	68 0c 09 00 00       	push   $0x90c
 221:	68 c1 08 00 00       	push   $0x8c1
 226:	6a 01                	push   $0x1
 228:	e8 c3 03 00 00       	call   5f0 <printf>
 22d:	83 c4 08             	add    $0x8,%esp
 230:	68 d5 08 00 00       	push   $0x8d5
 235:	6a 01                	push   $0x1
 237:	e8 b4 03 00 00       	call   5f0 <printf>
 23c:	83 c4 04             	add    $0x4,%esp
 23f:	ff 35 04 0d 00 00    	push   0xd04
 245:	e8 81 02 00 00       	call   4cb <kill>
 24a:	e8 4c 02 00 00       	call   49b <exit>
   printf(1, "TEST PASSED\n");
 24f:	83 ec 08             	sub    $0x8,%esp
 252:	68 2f 09 00 00       	push   $0x92f
 257:	6a 01                	push   $0x1
 259:	e8 92 03 00 00       	call   5f0 <printf>
   exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5a1:	0f b6 92 9c 09 00 00 	movzbl 0x99c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 66e:	ff 24 85 44 09 00 00 	jmp    *0x944(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 6d3:	75 15                	jne    6ea <printf+0xfa>
          s = "(null)";
 6d5:	be 3c 09 00 00       	mov    $0x93c,%esi
...
free(void *ap)
{
 ...
 762:	a1 08 0d 00 00       	mov    0xd08,%eax
 ...
 79e:	89 08                	mov    %ecx,(%eax)
  freep = p;
 7a0:	a3 08 0d 00 00       	mov    %eax,0xd08
}
 7a5:	5b                   	pop    %ebx
 7a6:	5e                   	pop    %esi
 7a7:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 7fd:	e8 54 ff ff ff       	call   756 <free>
  return freep;
 802:	a1 08 0d 00 00       	mov    0xd08,%eax
...
malloc(uint nbytes)
{
 ...
 826:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 829:	8b 0d 08 0d 00 00    	mov    0xd08,%ecx
 ...
 835:	eb 4a                	jmp    881 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 837:	c7 05 08 0d 00 00 0c 	movl   $0xd0c,0xd08
 83e:	0d 00 00 
 841:	c7 05 0c 0d 00 00 0c 	movl   $0xd0c,0xd0c
 848:	0d 00 00 
    base.s.size = 0;
 84b:	c7 05 10 0d 00 00 00 	movl   $0x0,0xd10
 852:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 855:	b9 0c 0d 00 00       	mov    $0xd0c,%ecx
 ...
 866:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 869:	89 0d 08 0d 00 00    	mov    %ecx,0xd08
      return (void*)(p + 1);
 ...
 886:	73 d4                	jae    85c <malloc+0x46>
    if(p == freep)
 888:	39 05 08 0d 00 00    	cmp    %eax,0xd08
