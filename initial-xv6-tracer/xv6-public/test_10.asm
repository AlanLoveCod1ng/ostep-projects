...
int main() {
  ...
  19:	e8 75 03 00 00       	call   393 <trace>
  1e:	83 c4 10             	add    $0x10,%esp
  21:	85 c0                	test   %eax,%eax
  23:	79 25                	jns    4a <main+0x4a>
  25:	eb 5c                	jmp    83 <main+0x83>
  ...
  33:	83 c3 01             	add    $0x1,%ebx
      open(PATH, 0);
  36:	6a 00                	push   $0x0
  38:	68 88 07 00 00       	push   $0x788
  3d:	e8 f1 02 00 00       	call   333 <open>
  42:	83 c4 10             	add    $0x10,%esp
  for (int i = 0; i < iter; i++) {
  45:	83 fb 14             	cmp    $0x14,%ebx
  48:	74 1f                	je     69 <main+0x69>
    if (i % 2 == 0) {
  4a:	f6 c3 01             	test   $0x1,%bl
  4d:	74 e1                	je     30 <main+0x30>
    } else {
      open("random", 0);
  ...
  5c:	e8 d2 02 00 00       	call   333 <open>
  61:	83 c4 10             	add    $0x10,%esp
  for (int i = 0; i < iter; i++) {
  64:	83 fb 14             	cmp    $0x14,%ebx
  67:	75 e1                	jne    4a <main+0x4a>
    }
  }

  int ret = getcount();
  69:	e8 2d 03 00 00       	call   39b <getcount>
  printf(1, "XV6_TEST_OUTPUT %d\n", ret);
  6e:	83 ec 04             	sub    $0x4,%esp
  71:	50                   	push   %eax
  72:	68 b6 07 00 00       	push   $0x7b6
  77:	6a 01                	push   $0x1
  79:	e8 e2 03 00 00       	call   460 <printf>
  ...
  83:	50                   	push   %eax
  84:	50                   	push   %eax
  85:	68 91 07 00 00       	push   $0x791
  8a:	6a 01                	push   $0x1
  8c:	e8 cf 03 00 00       	call   460 <printf>
    exit();
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 d4 07 00 00 	jmp    *0x7d4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba ca 07 00 00       	mov    $0x7ca,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 d8 0a 00 00    	mov    %edx,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf dc 0a 00 00       	mov    $0xadc,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 772:	00 00 00 
    if(p->s.size >= nunits){
