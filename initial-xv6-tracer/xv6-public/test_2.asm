...
int main() {
  ...
  12:	68 28 07 00 00       	push   $0x728
  17:	e8 17 03 00 00       	call   333 <trace>
  1c:	89 c3                	mov    %eax,%ebx
  int ret2 = getcount();
  1e:	e8 18 03 00 00       	call   33b <getcount>

  printf(1, "XV6_TEST_OUTPUT %d %d\n", ret1, ret2);
  23:	50                   	push   %eax
  24:	53                   	push   %ebx
  25:	68 34 07 00 00       	push   $0x734
  2a:	6a 01                	push   $0x1
  2c:	e8 cf 03 00 00       	call   400 <printf>
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 4b 07 00 00       	mov    $0x74b,%edx
        while(*s != 0){
 ...
 5a1:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 58 0a 00 00    	mov    %edx,0xa58
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 58 0a 00 00    	mov    %edx,0xa58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 58 0a 00 00    	mov    0xa58,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 58 0a 00 00    	mov    %edx,0xa58
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 58 0a 00 00 5c 	movl   $0xa5c,0xa58
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	bf 5c 0a 00 00       	mov    $0xa5c,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 706:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 712:	00 00 00 
    if(p->s.size >= nunits){
