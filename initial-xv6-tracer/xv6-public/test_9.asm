...
int main() {
  ...
  if (trace(PATH) < 0) {
  13:	68 a8 07 00 00       	push   $0x7a8
  18:	e8 96 03 00 00       	call   3b3 <trace>
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	78 30                	js     54 <main+0x54>
    printf(1, "XV6_TEST_OUTPUT trace failed\n");
    exit();
  }

  int ret = fork();
  24:	e8 e2 02 00 00       	call   30b <fork>
  if (ret < 0) {
  29:	85 c0                	test   %eax,%eax
  2b:	78 3a                	js     67 <main+0x67>
    printf(1, "XV6_TEST_OUTPUT fork failed\n");
    exit();
  } else if (ret == 0) {
  2d:	75 4b                	jne    7a <main+0x7a>
  2f:	bb 0a 00 00 00       	mov    $0xa,%ebx
  34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (int i = 0; i < iter; i++) {
      open(PATH, 0);
  38:	83 ec 08             	sub    $0x8,%esp
  3b:	6a 00                	push   $0x0
  3d:	68 a8 07 00 00       	push   $0x7a8
  42:	e8 0c 03 00 00       	call   353 <open>
    for (int i = 0; i < iter; i++) {
  47:	83 c4 10             	add    $0x10,%esp
  4a:	83 eb 01             	sub    $0x1,%ebx
  4d:	75 e9                	jne    38 <main+0x38>
    }
    exit();
  4f:	e8 bf 02 00 00       	call   313 <exit>
    printf(1, "XV6_TEST_OUTPUT trace failed\n");
  54:	52                   	push   %edx
  55:	52                   	push   %edx
  56:	68 b1 07 00 00       	push   $0x7b1
  5b:	6a 01                	push   $0x1
  5d:	e8 1e 04 00 00       	call   480 <printf>
    exit();
  62:	e8 ac 02 00 00       	call   313 <exit>
    printf(1, "XV6_TEST_OUTPUT fork failed\n");
  67:	50                   	push   %eax
  68:	50                   	push   %eax
  69:	68 cf 07 00 00       	push   $0x7cf
  6e:	6a 01                	push   $0x1
  70:	e8 0b 04 00 00       	call   480 <printf>
    exit();
  75:	e8 99 02 00 00       	call   313 <exit>
  } else {
    wait();
  7a:	e8 9c 02 00 00       	call   31b <wait>
  }

  int ret1 = getcount();
  7f:	bb 14 00 00 00       	mov    $0x14,%ebx
  84:	e8 32 03 00 00       	call   3bb <getcount>
  ...
  93:	6a 00                	push   $0x0
  95:	68 a8 07 00 00       	push   $0x7a8
  9a:	e8 b4 02 00 00       	call   353 <open>
  for (int i = 0; i < 2*iter; i++) {
  ...
  int ret2 = getcount();
  a7:	e8 0f 03 00 00       	call   3bb <getcount>
  
  printf(1, "XV6_TEST_OUTPUT %d %d\n", ret1, ret2);
  ac:	50                   	push   %eax
  ad:	56                   	push   %esi
  ae:	68 ec 07 00 00       	push   $0x7ec
  b3:	6a 01                	push   $0x1
  b5:	e8 c6 03 00 00       	call   480 <printf>

  exit();
  ba:	e8 54 02 00 00       	call   313 <exit>
  bf:	90                   	nop
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 0c 08 00 00 	jmp    *0x80c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 03 08 00 00       	mov    $0x803,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 14 0b 00 00    	mov    %edx,0xb14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 18 0b 00 00       	mov    $0xb18,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 792:	00 00 00 
    if(p->s.size >= nunits){
