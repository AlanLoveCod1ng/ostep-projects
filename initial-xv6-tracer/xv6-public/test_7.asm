...
int main() {
   ...
   b:	89 e5                	mov    %esp,%ebp
   d:	51                   	push   %ecx
   e:	8d 8d f7 fe ff ff    	lea    -0x109(%ebp),%ecx
  ...
  for(int i = 0; i < 256; i++) {
    filename[i] = 'a';
  20:	c6 00 61             	movb   $0x61,(%eax)
  for(int i = 0; i < 256; i++) {
  23:	83 c0 01             	add    $0x1,%eax
  26:	39 d0                	cmp    %edx,%eax
  ...
  filename[256] = '\0';
  2d:	c6 45 f7 00          	movb   $0x0,-0x9(%ebp)
  int ret = trace(filename);
  31:	51                   	push   %ecx
  32:	e8 0c 03 00 00       	call   343 <trace>
  printf(1, "XV6_TEST_OUTPUT %d\n", ret);
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	50                   	push   %eax
  3b:	68 38 07 00 00       	push   $0x738
  40:	6a 01                	push   $0x1
  42:	e8 c9 03 00 00       	call   410 <printf>
  exit();
 ...
 5b1:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 54 0a 00 00    	mov    %edx,0xa54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 54 0a 00 00    	mov    0xa54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 54 0a 00 00    	mov    0xa54,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 54 0a 00 00    	mov    0xa54,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 54 0a 00 00 58 	movl   $0xa58,0xa54
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 58 0a 00 00       	mov    $0xa58,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 722:	00 00 00 
    if(p->s.size >= nunits){
