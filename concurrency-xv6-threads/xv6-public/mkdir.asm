...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 c0 02 00 00       	call   313 <mkdir>
...
printf(int fd, const char *fmt, ...)
{
 ...
 47e:	ff 24 85 ec 06 00 00 	jmp    *0x6ec(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4e3:	75 15                	jne    4fa <printf+0xfa>
          s = "(null)";
 4e5:	be e3 06 00 00       	mov    $0x6e3,%esi
...
free(void *ap)
{
 ...
 572:	a1 94 0a 00 00       	mov    0xa94,%eax
 ...
 5ae:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5b0:	a3 94 0a 00 00       	mov    %eax,0xa94
}
 5b5:	5b                   	pop    %ebx
 5b6:	5e                   	pop    %esi
 5b7:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 60d:	e8 54 ff ff ff       	call   566 <free>
  return freep;
 612:	a1 94 0a 00 00       	mov    0xa94,%eax
...
malloc(uint nbytes)
{
 ...
 636:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 639:	8b 0d 94 0a 00 00    	mov    0xa94,%ecx
 ...
 645:	eb 4a                	jmp    691 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 647:	c7 05 94 0a 00 00 98 	movl   $0xa98,0xa94
 64e:	0a 00 00 
 651:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 658:	0a 00 00 
    base.s.size = 0;
 65b:	c7 05 9c 0a 00 00 00 	movl   $0x0,0xa9c
 662:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 665:	b9 98 0a 00 00       	mov    $0xa98,%ecx
 ...
 676:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 679:	89 0d 94 0a 00 00    	mov    %ecx,0xa94
      return (void*)(p + 1);
 ...
 696:	73 d4                	jae    66c <malloc+0x46>
    if(p == freep)
 698:	39 05 94 0a 00 00    	cmp    %eax,0xa94
