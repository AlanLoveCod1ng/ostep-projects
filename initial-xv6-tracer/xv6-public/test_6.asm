...
int main() {
  ...
  strcpy(buffer, PATH);
  15:	68 88 07 00 00       	push   $0x788
  1a:	53                   	push   %ebx
  1b:	e8 80 00 00 00       	call   a0 <strcpy>
  if (trace(buffer) < 0) {
  20:	89 1c 24             	mov    %ebx,(%esp)
  23:	e8 6b 03 00 00       	call   393 <trace>
  28:	83 c4 10             	add    $0x10,%esp
  2b:	85 c0                	test   %eax,%eax
  2d:	78 51                	js     80 <main+0x80>
  ...
  2f:	50                   	push   %eax
  30:	50                   	push   %eax
  31:	68 af 07 00 00       	push   $0x7af
  36:	53                   	push   %ebx
  37:	e8 64 00 00 00       	call   a0 <strcpy>
  open(PATH, 0);
  3c:	5a                   	pop    %edx
  3d:	59                   	pop    %ecx
  3e:	6a 00                	push   $0x0
  40:	68 88 07 00 00       	push   $0x788
  45:	e8 e9 02 00 00       	call   333 <open>
  open(PATH, 0);
  4a:	5b                   	pop    %ebx
  4b:	58                   	pop    %eax
  4c:	6a 00                	push   $0x0
  4e:	68 88 07 00 00       	push   $0x788
  53:	e8 db 02 00 00       	call   333 <open>
  open(PATH, 0);
  58:	58                   	pop    %eax
  59:	5a                   	pop    %edx
  5a:	6a 00                	push   $0x0
  5c:	68 88 07 00 00       	push   $0x788
  61:	e8 cd 02 00 00       	call   333 <open>

  int ret = getcount();
  66:	e8 30 03 00 00       	call   39b <getcount>
  printf(1, "XV6_TEST_OUTPUT %d\n", ret);
  6b:	83 c4 0c             	add    $0xc,%esp
  6e:	50                   	push   %eax
  6f:	68 bd 07 00 00       	push   $0x7bd
  74:	6a 01                	push   $0x1
  76:	e8 e5 03 00 00       	call   460 <printf>
  exit();
  7b:	e8 73 02 00 00       	call   2f3 <exit>
    printf(1, "XV6_TEST_OUTPUT trace failed\n");
  80:	51                   	push   %ecx
  81:	51                   	push   %ecx
  82:	68 91 07 00 00       	push   $0x791
  87:	6a 01                	push   $0x1
  89:	e8 d2 03 00 00       	call   460 <printf>
    exit();
  8e:	e8 60 02 00 00       	call   2f3 <exit>
  93:	66 90                	xchg   %ax,%ax
  95:	66 90                	xchg   %ax,%ax
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 d8 07 00 00 	jmp    *0x7d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba d1 07 00 00       	mov    $0x7d1,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 dc 0a 00 00       	mov    0xadc,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 dc 0a 00 00    	mov    %edx,0xadc
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 dc 0a 00 00    	mov    %edx,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf e0 0a 00 00       	mov    $0xae0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 772:	00 00 00 
    if(p->s.size >= nunits){
