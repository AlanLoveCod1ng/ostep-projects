...
int main() {
   ...
   e:	51                   	push   %ecx
  int ret0 = getcount();
   f:	e8 37 03 00 00       	call   34b <getcount>
  open("random file", 0);
  ...
  open("random file", 0);
  1b:	68 40 07 00 00       	push   $0x740
  20:	e8 be 02 00 00       	call   2e3 <open>
  open("another random file", 0);
  25:	58                   	pop    %eax
  26:	5a                   	pop    %edx
  27:	6a 00                	push   $0x0
  29:	68 38 07 00 00       	push   $0x738
  2e:	e8 b0 02 00 00       	call   2e3 <open>
  int ret1 = getcount();
  33:	e8 13 03 00 00       	call   34b <getcount>
  printf(1, "XV6_TEST_OUTPUT %d %d\n", ret0, ret1);
  38:	50                   	push   %eax
  39:	53                   	push   %ebx
  3a:	68 4c 07 00 00       	push   $0x74c
  3f:	6a 01                	push   $0x1
  41:	e8 ca 03 00 00       	call   410 <printf>
  exit();
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 6c 07 00 00 	jmp    *0x76c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 63 07 00 00       	mov    $0x763,%edx
        while(*s != 0){
